<%@ Page Title="" Language="C#" MasterPageFile="~/AdLog.Master" AutoEventWireup="true" CodeBehind="AdLogEventDashADD.aspx.cs" Inherits="RotaryClub.AdLogEventDashADD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        ...
        <div class="p-3 mb-2 bg-dark text-white">
            <h2 style="text-align: center; text-decoration: solid">Add Event(s): Event Management</h2>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    Name of the Event:
                    <asp:textbox id="TextBox1" runat="server" class="form-control" placeholder="Enter the name of the event"></asp:textbox>
                ...
                <div class="col">
                    Location:
                    <asp:textbox id="TextBox2" runat="server" class="form-control" placeholder="Enter the location of the event"></asp:textbox>
            ...
            <div class="row">
                <div class="col">
                    Time:
                    <asp:textbox id="TextBox3" runat="server" class="form-control" placeholder="Ex: 10 AM - 3PM (May-July, Every Second Saturday)"></asp:textbox>
                ...
                <div class="col">
                    Details:
                    <asp:textbox textmode="multiline" id="TextArea1" runat="server" class="form-control" placeholder="Enter the details of the event"></asp:textbox>
