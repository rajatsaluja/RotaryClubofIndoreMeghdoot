<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdLogProjectDash.aspx.cs" Inherits="RotaryClub.AdLogProjectDash" %>
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center .site-nav-utility-container" style="padding-top: 0px">
    ...
    <form id="form1" runat="server">
        <div class="p-3 mb-2 bg-dark text-white">
            <h2 style="text-align: center; text-decoration: solid">Project Management</h2>
        </div>
        ...
        <div class="row">
            <div class="col">
                Name of the Project:
                    <asp:TextBox ID="TB1" Width="300px" runat="server" placeholder="Enter the name of the project"></asp:TextBox>
                <br />
            ...
            <div class="col">
            <asp:Button ID="Add_btn" runat="server" Text="Add Project(s)" class="btn btn-secondary" type="button" Style="background-color: #5d7b9d" OnClick="Add_btn_Click" />
            &nbsp;&nbsp;
            <asp:Button ID="Update_btn" ValidationGroup="valgrp1" runat="server" Text="Update Project(s)" class="btn btn-secondary" type="button" Style="background-color: #5d7b9d" OnClick="Update_btn_Click" />
            &nbsp;&nbsp;<asp:Button ValidationGroup="valgrp1" ID="Del_btn" runat="server" Text="Delete Project(s)" class="btn btn-secondary" Style="background-color: #5d7b9d" type="button" OnClick="Del_btn_Click" />
        </div>
        ...
        <div class="container">
            <h5>Current List of Projects</h5>
