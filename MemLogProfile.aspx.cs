...
{
    public partial class MemLogProfile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //string struser = "";
                //struser = ds.Tables[0].Rows[0]["Username"].ToString();
                ...
                //SqlConnection con2 = new SqlConnection(@"Data Source=localhost;Initial Catalog=RotaryClub;Integrated Security=True");
        ...
        protected void SaveChanges_btn_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd4 = new SqlCommand("update MemLogin set FName='" + TB1 + "', LName='" + TB2 + "' where Username='" + TB4 + "'", con3);
